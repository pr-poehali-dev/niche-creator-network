...
export const t: Dict = {
  ...
  whyUsTitle: { ru: "Почему ищут здесь", en: "Five specializations in one directory" },
  ...
  whyUs2Title: { ru: "48 специальностей в одном месте", en: "Five specializations at once" },
  ...
  navCommunity: { ru: "Сообщество", en: "Community" },
  ...
  crumbCommunity: { ru: "Сообщество", en: "Community" },
  ...
  cfeat1Title: { ru: "Проверка документов модератором", en: "Documents checked by a moderator" },
  cfeat1Desc: { ru: "Документы и лицензии сверяет модератор. В анкете видно, что именно подтверждено, а что нет", en: "A moderator checks documents and licences. The profile shows exactly what is confirmed and what is not" },
  ...
  cfeat4Desc: { ru: "Оценки и отзывы других клиентов — чтобы решение было вашим, а не вслепую", en: "Ratings and reviews from other clients — so the choice is yours, not a guess" },
  ...
  profileReviewsTitle: { ru: "Отзывы клиентов", en: "Client reviews" },
  profileNoData: { ru: "Профиль не заполнен", en: "Profile not filled in" },
  profileNoReviews: { ru: "Пока нет отзывов", en: "No reviews yet" },
  profileAnonymous: { ru: "Клиент", en: "Client" },
  reportBtn: { ru: "Пожаловаться", en: "Report" },
  reportModalTitle: { ru: "Пожаловаться", en: "Report" },
  reportModalHint: { ru: "Выберите причину жалобы. Администрация рассмотрит обращение в ближайшее время.", en: "Choose a reason for your report. Our team will review it shortly." },
  reportModalPh: { ru: "Опишите подробности (необязательно)", en: "Describe the details (optional)" },
  reportModalSubmit: { ru: "Отправить жалобу", en: "Submit report" },
  reportReason_spam: { ru: "Спам", en: "Spam" },
  reportReason_scam: { ru: "Мошенничество", en: "Scam" },
  reportReason_illegal: { ru: "Незаконная деятельность", en: "Illegal activity" },
  reportReason_harassment: { ru: "Оскорбления", en: "Harassment" },
  reportReason_fake_profile: { ru: "Поддельный профиль", en: "Fake profile" },
  reportReason_other: { ru: "Другое", en: "Other" },
  reportSentTitle: { ru: "Жалоба отправлена", en: "Report submitted" },
  reportSentText: { ru: "Спасибо! Мы рассмотрим вашу жалобу в ближайшее время.", en: "Thank you! We will review your report shortly." },
  ...
  notifEmpty: { ru: "Пока нет уведомлений", en: "No notifications yet" },
  notifMarkAll: { ru: "Прочитать все", en: "Mark all read" },
  notifEmailDup: { ru: "Дублировать на почту", en: "Email duplicates" },
  notifEmailOn: { ru: "Копии уведомлений приходят на вашу почту", en: "Copies of notifications are sent to your email" },
  notifEmailOff: { ru: "Уведомления на почту отключены", en: "Email notifications are off" },
  notifJustNow: { ru: "только что", en: "just now" },
  notifMinAgo: { ru: "мин назад", en: "min ago" },
  notifHourAgo: { ru: "ч назад", en: "h ago" },
  notifDayAgo: { ru: "дн назад", en: "d ago" },
  notifAria: { ru: "Уведомления", en: "Notifications" },
  ...
  casesIntro: { ru: "Разборы типовых задач: как устроена работа по каждому направлению, что входит в проверку и на что обращать внимание.", en: "Walk-throughs of typical tasks: how work is structured in each area, what a check includes and what to look out for." },
  casesNote: { ru: "Имена клиентов и детали конкретных заказов здесь не публикуются: работа специалистов по безопасности конфиденциальна. Реальные отзывы появятся в профилях специалистов после первых сделок — мы не показываем то, чего ещё не было.", en: "Client names and details of specific orders are not published here: security work is confidential. Real reviews will appear in specialists' profiles after the first deals — we do not display what has not happened yet." },
  ...
  servicesDesc: { ru: "Услуги специалистов, чьи документы и лицензии мы проверили вручную", en: "Services from specialists whose documents and licenses we checked by hand" },
  ...
  guardsEmptyTitle: { ru: "Охранные компании пока не добавлены", en: "No security companies listed yet" },
  guardsEmptyText: { ru: "Мы не показываем компании, которых нет: лицензию каждого охранного предприятия проверяет живой человек, и до проверки карточка не публикуется. Если вы представляете ЧОП или охранное агентство — зарегистрируйтесь, мы проверим документы и откроем профиль.", en: "We do not display companies that do not exist: every security firm's licence is checked by a person, and no profile is published before that check. If you represent a security company, sign up — we will verify your documents and open your profile." },
  guardServicesNote: { ru: "Направления, по которым работают охранные предприятия на платформе.", en: "Areas covered by security companies on the platform." },
  ...
  writeMessage: { ru: "Написать...", en: "Write..." },
  ...
  pol1Text: { ru: "Телефоны, email, мессенджеры и контактные данные шифруются до записи в базу — алгоритмом AES-128 в режиме CBC с проверкой целостности HMAC-SHA256 (схема Fernet). Даже при прямом доступе к базе эти поля не читаются: там лежит шифртекст. Ключ хранится в отдельном защищённом хранилище, физически вне базы данных, и недоступен ни администраторам, ни сотрудникам платформы.", en: "Sensitive personal data — phone numbers, emails, full names and passport data — is encrypted with AES before being stored in the database. The encryption key is stored separately from the data in a protected secrets vault and is not directly accessible to platform staff." },

  pol2Title: { ru: "2. Защита аутентификации", en: "2. Authentication security" },
  pol2Text: { ru: "Пароль не хранится нигде и ни в каком виде — только необратимый хеш PBKDF2-HMAC-SHA256 со 120 000 итераций и уникальной солью для каждого пользователя. Восстановить из него пароль невозможно, перебор занимает непрактично много времени. Вход защищён от подбора ограничением попыток, сессии живут ограниченный срок и завершаются сразу при смене пароля — на всех устройствах. Двухфакторный вход по коду на почту доступен всем.", en: "Passwords are never stored in plain text — we use irreversible PBKDF2 hashing with a unique salt for each user. Sessions are protected by tokens with a limited lifetime, and sign-in is additionally protected against password guessing. Two-factor authentication (2FA) via email is available for specialists." },
  ...
  pol6Text: { ru: "Каждый специалист и охранное предприятие проходят проверку документов и лицензий перед допуском на платформу. Это снижает риск мошенничества. Проверка подтверждает документы, но не заменяет ваш собственный выбор и не является гарантией качества услуги.", en: "Every specialist and security firm undergoes document and license verification before joining the platform. This lowers the risk of fraud. Verification confirms documents — it does not replace your own judgement and is not a guarantee of service quality." },
  ...
  pol9Title: { ru: "9. Чего наша защита НЕ делает", en: "9. What our protection does NOT do" },
  pol9Text: { ru: "Обещать «полную защиту» было бы нечестно, поэтому называем границы прямо. Шифрование переписки — не сквозное (end-to-end): сообщения шифруются на сервере, а значит технически расшифровываемы по мотивированному требованию суда или следствия. Ключ защищает данные от утечки базы и от постороннего доступа, но не делает платформу недосягаемой для закона. Мы не храним содержимое ваших звонков и встреч вне платформы. Мы не отвечаем за то, что происходит после того, как вы передали специалисту контакты и ушли в другой мессенджер. И мы не проверяем качество самой услуги — только подлинность документов исполнителя.", en: "Promising «full protection» would be dishonest, so we state the limits plainly. Message encryption is not end-to-end: messages are encrypted on the server, which means they are technically decryptable upon a lawful court or investigative request. The key protects data from a database leak and outside access, but does not place the platform beyond the reach of the law. We do not store the content of your calls or offline meetings. We are not responsible for what happens after you hand a specialist your contacts and move to another messenger. And we do not vet the quality of the service itself — only the authenticity of the provider's documents." },
  pol10Title: { ru: "10. Нашли уязвимость — сообщите", en: "10. Found a vulnerability — tell us" },
  pol10Text: { ru: "Если вы обнаружили брешь в защите платформы, напишите на shieldpspl@yandex.ru с пометкой «безопасность» в теме письма. Мы отвечаем в течение 72 часов, не преследуем исследователей, которые действовали добросовестно, и не обращаемся в правоохранительные органы, если уязвимость не эксплуатировалась во вред пользователям. Просьба не публиковать находку до того, как мы её закроем, и не трогать чужие данные при проверке. Денежного вознаграждения пока нет — платформа молодая, но имя исследователя с его согласия указываем в благодарностях.", en: "If you have found a flaw in the platform's security, email shieldpspl@yandex.ru with «security» in the subject line. We respond within 72 hours, do not pursue researchers acting in good faith, and do not involve law enforcement unless the vulnerability was exploited to harm users. Please do not publish the finding before we fix it, and do not touch other people's data while testing. There is no monetary reward yet — the platform is young — but with your consent we credit researchers by name." },
  ...
  priv6Text: { ru: "Мы используем файлы cookie и аналогичные технологии. Мы делим их на категории: (1) НЕОБХОДИМЫЕ — обеспечивают вход в аккаунт, сохранение сессии, выбор языка и безопасность; без них сайт не работает, поэтому они устанавливаются всегда. (2) АНАЛИТИЧЕСКИЕ — помогают понять, как посетители пользуются сайтом; для этого мы применяем сервис Яндекс.Метрика (mc.yandex.ru), который собирает обезличенную статистику (просмотры, источники переходов, тип устройства). (3) ФУНКЦИОНАЛЬНЫЕ — запоминают ваши предпочтения (например, избранных специалистов и настройки). Аналитические и функциональные cookie применяются только после вашего согласия через баннер при первом визите. Согласие можно в любой момент отозвать: очистите cookie в настройках браузера или включите режим приватного просмотра. Срок хранения cookie — от завершения сессии до 1 года в зависимости от их назначения. Отключение необходимых cookie может нарушить работу сайта.", en: "We use cookies and similar technologies. We group them into categories: (1) ESSENTIAL — enable account login, session persistence, language choice and security; the site cannot function without them, so they are always set. (2) ANALYTICS — help us understand how visitors use the site; for this we use Yandex.Metrica (mc.yandex.ru), which collects anonymized statistics (page views, referral sources, device type). (3) FUNCTIONAL — remember your preferences (e.g. favorite specialists and settings). Analytics and functional cookies are used only after your consent given via the banner on your first visit. You can withdraw consent at any time: clear cookies in your browser settings or use private browsing mode. Cookie lifetime ranges from the end of the session up to 1 year depending on their purpose. Disabling essential cookies may break the site." },
  ...
  offer3Title: { ru: "3. Срок действия подписки", en: "3. Subscription term" },
  offer3Text: { ru: "Услуга начинает оказываться сразу после поступления оплаты и действует 30 календарных дней при месячной подписке либо 365 календарных дней при годовой. Дата окончания видна в личном кабинете. Автосписаний нет: подписка не продлевается сама, продление вы подтверждаете вручную.", en: "The service starts immediately after payment is received and runs for 30 calendar days on a monthly subscription or 365 calendar days on an annual one. The end date is shown in your dashboard. There are no automatic charges: the subscription does not renew itself — you confirm each renewal manually." },
  ...
  heroClientCta3: { ru: "Оставить заявку", en: "Leave a request" },
  ...
  hiwStep2Text: { ru: "Клиент указывает город, страну и нужную специализацию — платформа показывает подходящих исполнителей. Чем выше рейтинг и активнее профиль, тем выше вы в выдаче.", en: "Clients enter their city, country and the specialty they need — the platform shows matching providers. The higher your rating and profile activity, the higher you rank." },
  hiwStep3Title: { ru: "3. Заявки и сообщения приходят в личный кабинет", en: "3. Requests and messages land in your dashboard" },
  hiwStep3Text: { ru: "Все обращения клиентов появляются во вкладке «Заявки» вашего личного кабинета. Отвечайте прямо в чате — обсуждайте детали заказа, согласовывайте цену и сроки.", en: "Every client request appears in the «Requests» tab of your dashboard. Reply right in the chat — discuss order details, agree on price and timing." },
  hiwStep4Title: { ru: "4. Выполняете услугу и получаете оплату", en: "4. You complete the job and get paid" },
  hiwStep4Text: { ru: "Договорённости о цене и оплате — напрямую между вами и клиентом. Платформа не берёт комиссию с заказов — вы оставляете себе всю сумму.", en: "Price and payment terms are agreed directly between you and the client. The platform takes no commission on orders — you keep the full amount." },
  hiwStep5Title: { ru: "5. Получайте отзывы и растите в рейтинге", en: "5. Collect reviews and grow your rating" },
  hiwStep5Text: { ru: "После заказа клиент оставляет отзыв и оценку. Рейтинг влияет на место в выдаче — чем он выше, тем чаще вас видят.", en: "After the order the client leaves a review and rating. Your rating affects your position in the list — the higher it is, the more often you are seen." },
  hiwCtaTitle: { ru: "Готовы начать получать заказы?", en: "Ready to start getting orders?" },
  hiwCtaBtn: { ru: "Перейти в личный кабинет", en: "Go to dashboard" },
  ...
  planChopName: { ru: "Для ЧОП", en: "For Security Firms" },
  planChopPrice: { ru: "12 990 ₽", en: "$139" },
  planHrName: { ru: "Доступ к базе резюме", en: "Resume database access" },
  planHrPrice: { ru: "9 900 ₽", en: "$105" },
  hrBlockTag: { ru: "Работодателям", en: "For employers" },
  hrBlockTitle: { ru: "Ищете специалиста по безопасности в штат?", en: "Hiring a security specialist?" },
  hrBlockDesc: { ru: "Полиграфологи, детективы, начальники охраны и специалисты по безопасности, которые сами отметили, что открыты к предложениям. Не холодная база, а живые кандидаты в поиске работы.", en: "Polygraph examiners, detectives, heads of security and safety specialists who marked themselves open to offers. Not a cold database — real candidates looking for a job." },
  hrFeatBase: { ru: "База кандидатов отрасли безопасности", en: "Security industry candidate database" },
  hrFeatFilters: { ru: "Фильтры по городу, опыту и формату работы", en: "Filters by city, experience and work format" },
  hrFeatContacts: { ru: "Прямые контакты: телефон и почта", en: "Direct contacts: phone and email" },
  hrFeatUnlimited: { ru: "Без лимита на количество откликов", en: "No limit on the number of contacts" },
  hrFeatVerified: { ru: "Отметка о проверке документов специалиста", en: "Document verification badge" },
  hrFeatConsent: { ru: "Только те, кто согласился на публикацию резюме", en: "Only those who agreed to publish a resume" },
  hrPlanLabel: { ru: "Подписка работодателя", en: "Employer subscription" },
  hrPerMonth: { ru: "в месяц, без комиссии за найм", en: "per month, no hiring fee" },
  hrPlanNote: { ru: "Пока подписка активна — открываете сколько угодно резюме. Комиссию с найма мы не берём: наняли специалиста — платите только ему.", en: "While the subscription is active you can open any number of resumes. We take no hiring fee — you pay the specialist, not us." },
  hrPlanCta: { ru: "Открыть базу резюме", en: "Open resume database" },
  planChopFor: { ru: "Для частных охранных предприятий", en: "For private security companies" },
  planChopBadge: { ru: "Для ЧОП", en: "Security firm" },
  featChopVerified: { ru: "Верификация лицензии ЧОП", en: "Security license verification" },
  featChopTeam: { ru: "До 10 сотрудников в профиле", en: "Up to 10 staff members in profile" },
  planEntName: { ru: "Корпоративный", en: "Enterprise" },
  planEntPrice: { ru: "По запросу", en: "Custom" },
  planEntFor: { ru: "Индивидуальные условия для крупного бизнеса", en: "Custom terms for large businesses" },
  ...
  featCourses: { ru: "Доступ к курсам (скоро)", en: "Access to courses (coming soon)" },
  ...
  premiumValueNote: { ru: "Карточка оформлена заметнее и стоит выше в списке. Внимание клиентов это не гарантирует — но шансов, что вас увидят, больше.", en: "Your card looks bolder and sits higher in the list. That guarantees no attention — but the odds of being seen go up." },
  ...
  pdPremB2: { ru: "Профиль поднимается выше в списке выдачи.", en: "Your profile sits higher in the results list." },
  ...
  payProvidersOnly: { ru: "Подписка нужна только специалистам. Для клиентов платформа бесплатна.", en: "A subscription is only required for specialists. The platform is free for clients." },
  payClientsOnly: { ru: "Доступ к базе резюме оформляют работодатели. Вы вошли как специалист — своё резюме можно заполнить в личном кабинете.", en: "Resume database access is for employers. You are signed in as a specialist — fill in your own resume in the dashboard." },
  payTooMany: { ru: "Слишком много попыток оплаты подряд. Подождите несколько минут и попробуйте снова.", en: "Too many payment attempts in a row. Please wait a few minutes and try again." },
  ...
  reqNew: { ru: "Оставить заявку", en: "Leave a request" },
  ...
  reqNeededDate: { ru: "Дата услуги", en: "Service date" },
  reqNeededTime: { ru: "Время услуги", en: "Service time" },
  reqNeededWhen: { ru: "Когда нужно", en: "Needed by" },
  reqPublish: { ru: "Оставить заявку", en: "Leave a request" },
  reqComplete: { ru: "Завершить", en: "Complete" },
  ...
  reqStatusDone: { ru: "Завершена", en: "Completed" },
  reqLeaveReview: { ru: "Оставить отзыв", en: "Leave a review" },
  reqReviewSent: { ru: "Отзыв отправлен", en: "Review sent" },
  reviewModalTitle: { ru: "Оцените исполнителя", en: "Rate the provider" },
  reviewModalHint: { ru: "Ваш отзыв поможет другим клиентам и повлияет на позицию специалиста в поиске.", en: "Your review helps other clients and affects the specialist's search ranking." },
  reviewModalPh: { ru: "Расскажите о своём опыте работы (необязательно)", en: "Share your experience (optional)" },
  reviewModalSubmit: { ru: "Отправить отзыв", en: "Submit review" },
  favAdd: { ru: "В избранное", en: "Add to favorites" },
  favRemove: { ru: "Убрать из избранного", en: "Remove from favorites" },
  favEmpty: { ru: "В избранном пока пусто. Добавляйте специалистов кнопкой-сердечком в каталоге.", en: "No favorites yet. Add specialists with the heart button in the catalog." },
  ...
  adminTabProviders: { ru: "Исполнители", en: "Providers" },
  adminTabComplaints: { ru: "Жалобы", en: "Complaints" },
  adminComplaintsEmpty: { ru: "Жалоб пока нет", en: "No complaints yet" },
  adminComplaintNew: { ru: "Новая", en: "New" },
  adminComplaintResolved: { ru: "Решено", en: "Resolved" },
  adminComplaintDismissed: { ru: "Отклонено", en: "Dismissed" },
  adminComplaintResolve: { ru: "Решено", en: "Resolve" },
  adminComplaintDismiss: { ru: "Отклонить", en: "Dismiss" },
  reportTargetProvider: { ru: "Профиль исполнителя", en: "Provider profile" },
  reportTargetClient: { ru: "Профиль клиента", en: "Client profile" },
  reportTargetMessage: { ru: "Сообщение", en: "Message" },
  reportTargetForum: { ru: "Тема форума", en: "Forum topic" },
  adminGoToProvider: { ru: "Перейти к профилю", en: "Go to profile" },
  adminViewTopic: { ru: "Показать тему", en: "View topic" },
  adminHideTopic: { ru: "Скрыть тему", en: "Hide topic" },
  adminNoClientProfile: { ru: "У клиентов нет публичного профиля", en: "Clients have no public profile" },
  adminMessageEncrypted: { ru: "Переписка зашифрована и недоступна для чтения", en: "The conversation is encrypted and cannot be read" },
  ...
  chatSending: { ru: "Отправляется…", en: "Sending…" },
  chatDelivered: { ru: "Доставлено", en: "Delivered" },
  chatRead: { ru: "Прочитано", en: "Read" },
  ...
  // Резюме исполнителя
  pdTabResume: { ru: "Резюме", en: "Resume" },
  resLookingTitle: { ru: "Ищу работу", en: "Open to work" },
  resLookingOn: { ru: "Резюме опубликовано. Работодатели видят вашу специализацию, опыт и ожидания по оплате. Имя, фото и контакты открываются только компаниям с оплаченным доступом.", en: "Your resume is published. Employers see your role, experience and salary expectations. Name, photo and contacts are revealed only to companies with paid access." },
  resLookingOff: { ru: "Резюме скрыто. Вы остаётесь обычным исполнителем — работодатели вас не видят. Включите переключатель, когда захотите найти работу.", en: "Your resume is hidden. You remain a regular provider and employers cannot see you. Turn it on whenever you want to look for a job." },
  resNeedPosition: { ru: "Укажите желаемую должность — без неё резюме нельзя опубликовать.", en: "Add a desired position — a resume cannot be published without it." },
  resViewsTitle: { ru: "Ваше резюме смотрели", en: "Resume views" },
  resFormTitle: { ru: "Данные резюме", en: "Resume details" },
  resFormHint: { ru: "Заполните то, что считаете нужным. Сохранение не публикует резюме — публикация включается отдельно.", en: "Fill in what you find relevant. Saving does not publish the resume — publishing is a separate switch." },
  resPosition: { ru: "Желаемая должность", en: "Desired position" },
  resPositionPh: { ru: "Например: Начальник службы безопасности", en: "E.g. Head of security" },
  resCity: { ru: "Город", en: "City" },
  resCityPh: { ru: "Москва", en: "London" },
  resExperience: { ru: "Опыт работы, лет", en: "Experience, years" },
  resExpShort: { ru: "Опыт", en: "Exp." },
  resSalary: { ru: "Зарплатные ожидания, от", en: "Salary expectations, from" },
  resSalaryPh: { ru: "150000", en: "150000" },
  resSalaryAny: { ru: "Зарплата по договорённости", en: "Salary negotiable" },
  resFrom: { ru: "от", en: "from" },
  resEmployment: { ru: "Тип занятости", en: "Employment type" },
  resEmpFull: { ru: "Полная", en: "Full-time" },
  resEmpPart: { ru: "Частичная", en: "Part-time" },
  resEmpProject: { ru: "Проектная", en: "Project" },
  resEmpShift: { ru: "Вахта", en: "Shift" },
  resRemote: { ru: "Удалённо", en: "Remote" },
  resRelocation: { ru: "Готов к переезду", en: "Open to relocation" },
  resSkills: { ru: "Навыки", en: "Skills" },
  resSkillsPh: { ru: "Введите навык и нажмите Enter", en: "Type a skill and press Enter" },
  resAbout: { ru: "О себе", en: "About" },
  resAboutPh: { ru: "Коротко о профессиональном опыте и сильных сторонах", en: "Briefly about your experience and strengths" },
  resEducation: { ru: "Образование", en: "Education" },
  resEducationPh: { ru: "Учебные заведения, курсы, сертификаты", en: "Schools, courses, certificates" },
  resHistory: { ru: "Опыт работы", en: "Work history" },
  resHistoryPh: { ru: "Место работы, должность, период, обязанности", en: "Company, role, period, responsibilities" },
  resContactsHint: { ru: "Телефон и почту видят только работодатели с оплаченным доступом. В базе они хранятся в зашифрованном виде.", en: "Phone and email are visible only to employers with paid access. They are stored encrypted." },
  resSaved: { ru: "Резюме сохранено", en: "Resume saved" },

  // Поиск резюме для работодателей
  resSearchTag: { ru: "Подбор персонала", en: "Recruitment" },
  resSearchTitle: { ru: "База резюме специалистов", en: "Security specialists resume database" },
  resSearchDesc: { ru: "Полиграфологи, детективы, охрана, специалисты по безопасности — те, кто открыто ищет работу.", en: "Polygraph examiners, detectives, guards and security specialists open to work." },
  resSearchPh: { ru: "Должность или навык", en: "Position or skill" },
  resPaywallTitle: { ru: "Контакты кандидатов доступны по подписке", en: "Candidate contacts require a subscription" },
  resPaywallDesc: { ru: "Сейчас вы видите обезличенные карточки: специализация, опыт, город и ожидания по оплате. Подписка открывает имя, фото и прямые контакты всех кандидатов без ограничений по количеству.", en: "You currently see anonymised cards: role, experience, city and salary expectations. The subscription reveals names, photos and direct contacts of all candidates with no limits." },
  resPaywallCta: { ru: "Открыть доступ · 9 900 ₽/мес", en: "Get access · $105/mo" },
  resAccessActive: { ru: "Доступ к базе резюме активен. Укажите название компании — кандидат увидит, кто открыл его резюме.", en: "Resume database access is active. Add your company name — candidates will see who opened their resume." },
  resCompanyPh: { ru: "Название компании", en: "Company name" },
  resHiddenName: { ru: "Имя и контакты скрыты", en: "Name and contacts hidden" },
  resUnlockCta: { ru: "Открыть контакты", en: "Unlock contacts" },
  resOpenCta: { ru: "Открыть резюме", en: "Open resume" },
  resFoundCount: { ru: "Найдено резюме", en: "Resumes found" },
  resNothingFound: { ru: "По этим условиям резюме не найдено. Попробуйте изменить запрос.", en: "No resumes match these filters. Try changing your query." },
  resNeedAuthTitle: { ru: "Войдите, чтобы открыть базу резюме", en: "Sign in to open the resume database" },
  resNeedAuthDesc: { ru: "Резюме специалистов доступны работодателям после входа в аккаунт. Регистрация занимает минуту, обезличенные карточки кандидатов открываются сразу и бесплатно.", en: "Specialist resumes are available to employers after signing in. Registration takes a minute, and anonymised candidate cards open right away for free." },
  resContacts: { ru: "Контакты кандидата", en: "Candidate contacts" },
  resNoContacts: { ru: "Кандидат не указал контакты — свяжитесь через чат на площадке.", en: "The candidate left no contacts — reach out via the platform chat." },
  ...
  lpHowDesc: { ru: "От выбора услуги до прямого контакта со специалистом. Без посредников и комиссий.", en: "From choosing a service to contacting the specialist directly. No middlemen, no fees." },
  ...
  lpHow2Title: { ru: "Сравните анкеты", en: "Compare profiles" },
  lpHow2Desc: { ru: "Специализация, опыт, документы. Видно, кто прошёл проверку, а кто ещё нет.", en: "Specialisation, experience, documents. You see who passed verification and who has not." },
  ...
  lpValClient2: { ru: "Значок проверки — только после сверки документов", en: "Verified badge only after documents are checked" },
  lpValClient3: { ru: "Отзывы только от подтверждённых заказчиков", en: "Reviews only from confirmed clients" },
  ...
  lpRevTitle: { ru: "На чём строится доверие", en: "What trust is built on" },
  lpCtaTitle: { ru: "Готовы начать?", en: "Ready to start?" },
  lpCtaDesc: { ru: "Регистрация занимает минуту. Каталог, контакты специалистов и защищённый чат — бесплатно для клиентов.", en: "Registration takes a minute. Catalogue, specialist contacts and secure chat — free for clients." },
  ...
  earlyText: { ru: "Платформа запускается, и мы отбираем специалистов вручную — каждый документ проверяет человек. Поэтому каталог растёт медленно, зато в нём нет случайных людей. Первые участники получают лучшие условия и заметное место в выдаче.", en: "The platform is launching and we select specialists manually — every document is checked by a person. That is why the catalogue grows slowly, but there are no random people in it. Early members get the best terms and prominent placement." },
  earlyB1: { ru: "Проверка документов без очереди", en: "Priority document verification" },
  earlyB2: { ru: "Скидка 30% на первый период", en: "30% off your first period" },
  earlyB3: { ru: "Приоритет в выдаче каталога", en: "Priority placement in the catalogue" },
  earlyBtn: { ru: "Разместить свой профиль", en: "List your profile" },
  demoBadge: { ru: "Образец", en: "Sample" },
  demoNoticeTitle: { ru: "Это демонстрационная карточка", en: "This is a demo profile" },
  demoNoticeText: { ru: "Мы показываем, как выглядит профиль специалиста на платформе. Связаться с этим профилем нельзя. Оставьте заявку — её увидят настоящие специалисты и ответят вам.", en: "This shows what a specialist profile looks like on the platform. You cannot contact this profile. Post a request — real specialists will see it and reply." },
  demoNoticeBtn: { ru: "Оставить заявку специалистам", en: "Post a request to specialists" },
  lpTrustTitle: { ru: "На чём построено доверие", en: "What our trust is built on" },
  lpTrustNote: { ru: "Мы не публикуем отзывы, пока их не оставили настоящие клиенты. Здесь — правила, по которым работает платформа.", en: "We do not publish reviews until real clients leave them. Here are the rules the platform works by." },
  lpTrust1Title: { ru: "Проверка документов", en: "Document verification" },
  lpTrust1Desc: { ru: "Лицензии и правовой статус специалистов проверяет человек, а не автоматика. Знак проверки получают только те, кто подтвердил документы.", en: "Licenses and legal status are checked by a person, not automation. The verified badge is given only to those who confirmed their documents." },
  lpTrust2Title: { ru: "Защита персональных данных", en: "Personal data protection" },
  lpTrust2Desc: { ru: "Контакты и переписка шифруются, а телефоны специалистов скрыты от посторонних и автоматических сборщиков данных.", en: "Contacts and messages are encrypted, and specialists' phone numbers are hidden from outsiders and automated data harvesters." },
  lpTrust3Title: { ru: "Честные условия", en: "Fair terms" },
  lpTrust3Desc: { ru: "Мы не берём комиссию со сделок и не вмешиваемся в расчёты между вами и специалистом — только подписка за размещение.", en: "We take no commission from deals and do not interfere with settlements between you and the specialist — only a listing subscription." },
  lpRevAnon: { ru: "Клиент платформы", en: "Platform client" },
  sessDevices: { ru: "Входы в аккаунт", en: "Account sign-ins" },
  sessHint: { ru: "Устройства, с которых заходили в ваш аккаунт. Если видите незнакомое — завершите сеансы и смените пароль.", en: "Devices used to sign in to your account. If you see an unfamiliar one, end the sessions and change your password." },
  sessLoading: { ru: "Загружаем…", en: "Loading…" },
  sessError: { ru: "Не удалось загрузить список. Попробуйте обновить страницу.", en: "Could not load the list. Try refreshing the page." },
  sessEmpty: { ru: "Активных сеансов не найдено.", en: "No active sessions found." },
  sessCurrent: { ru: "это вы сейчас", en: "current device" },
  sessLastSeen: { ru: "Последняя активность", en: "Last active" },
  sessEndOthers: { ru: "Завершить все сеансы", en: "End all sessions" },
  ...
  cdTab1: { ru: "Профиль", en: "Profile" },
  cdTab2: { ru: "Мои задачи", en: "My tasks" },
  cdTab3: { ru: "Избранное", en: "Favorites" },
  cdTab4: { ru: "Настройки", en: "Settings" },
  cdProfileLocked: { ru: "Данные профиля заполнены. Изменить их можно только через поддержку платформы —", en: "Your profile data is filled in. You can change it only through platform support —" },
  cdContactSupport: { ru: "написать в поддержку", en: "contact support" },
  setNotifTitle: { ru: "Уведомления", en: "Notifications" },
  setContactTitle: { ru: "Предпочитаемый способ связи", en: "Preferred contact method" },
  setContactChat: { ru: "Чат", en: "Chat" },
  setContactPhone: { ru: "Звонок", en: "Call" },
  setContactEmail: { ru: "Почта", en: "Email" },
  setContactMessenger: { ru: "Мессенджер", en: "Messenger" },
  setQuietTitle: { ru: "Часы тишины", en: "Quiet hours" },
  setQuietHint: { ru: "В это время специалисты не будут вас беспокоить звонками и сообщениями.", en: "During these hours specialists won't disturb you with calls and messages." },
  setQuietFrom: { ru: "С", en: "From" },
  setQuietTo: { ru: "До", en: "To" },
  setQuietClear: { ru: "Сбросить часы тишины", en: "Clear quiet hours" },
  // Client profile
  ...
  pdMyTasksTitle: { ru: "Заявки, где выбрали вас", en: "Requests where you were chosen" },
  pdMyTasksHint: { ru: "Отметьте задачу выполненной, когда закончите работу — это откроет клиенту возможность оставить отзыв.", en: "Mark a task done once you finish the work — this lets the client leave a review." },
  pdMarkDone: { ru: "Отметить выполненной", en: "Mark as done" },
  pdTaskDoneBadge: { ru: "Отмечено выполненным", en: "Marked done" },
  ...
  blogRelated: { ru: "Читайте дальше", en: "Read next" },
  blogGoCat: { ru: "Подобрать специалиста", en: "Find a specialist" },
  blogCatIntro: { ru: "По этой теме работают специалисты направления", en: "Specialists in this area" },
  blogGoPricing: { ru: "Смотреть условия", en: "See the terms" },
  blogCtaProvTitle: { ru: "Хотите получать такие заказы?", en: "Want to receive orders like these?" },
  blogCtaProvText: { ru: "Клиенты находят специалистов на платформе сами. Фиксированная подписка, комиссии со сделок нет — весь доход с заказов остаётся у вас.", en: "Clients find specialists on the platform themselves. A flat subscription, no commission on deals — the full order income stays with you." },
  ...
  heroGuarantee: { ru: "Лицензии и документы проверены до допуска на площадку", en: "Licenses and documents checked before joining" },
  ...
  pdTabFriends: { ru: "Сообщество", en: "Community" },
  pdMyIdTitle: { ru: "Ваш уникальный ID", en: "Your unique ID" },
  pdMyIdHint: { ru: "Сообщите этот номер коллегам — по нему вас найдут точно, без совпадений имён.", en: "Share this number with colleagues — it finds you exactly, with no name clashes." },
  pdFindFriendTitle: { ru: "Найти коллегу", en: "Find a colleague" },
  pdFindFriendHint: { ru: "Ищите по имени, специализации или номеру ID. Переписываться можно только после того, как коллега примет вашу заявку.", en: "Search by name, specialisation or ID number. You can message only after a colleague accepts your request." },
  pdFindFriendPh: { ru: "Имя, специализация или ID", en: "Name, specialisation or ID" },
  pdFindFriendBtn: { ru: "Найти", en: "Find" },
  pdFriendNotFound: { ru: "Никого не нашли. Попробуйте другое имя, специализацию или номер ID.", en: "Nobody found. Try another name, specialisation or ID." },
  pdAddFriend: { ru: "Добавить в друзья", en: "Add friend" },
  ...
  pdRemoveFriend: { ru: "Удалить из друзей", en: "Remove friend" },
  pdRemoveFriendConfirm: { ru: "Удалить из друзей? Переписка станет недоступна обоим.", en: "Remove this friend? The chat will become unavailable to both of you." },
  pdMessage: { ru: "Написать", en: "Message" },
  ...
  pdVfCountry: { ru: "Страна верификации", en: "Verification country" },
  pdVfCountryRU: { ru: "Россия", en: "Russia" },
  pdVfCountryUS: { ru: "США", en: "USA" },
  pdVfCountryEU: { ru: "ЕС", en: "EU" },
  pdVfCountryOther: { ru: "Другая", en: "Other" },
  pdVfCountryOtherHint: { ru: "Для вашей страны нет отдельной формы документа. Укажите номер лицензии в свободном виде или напишите в поддержку — мы поможем оформить верификацию.", en: "There's no dedicated document form for your country yet. Enter your license number freely or contact support — we'll help you get verified." },
  pdVfLicensePhUS: { ru: "Номер State Security License", en: "State Security License number" },
  pdVfLicensePhEU: { ru: "Номер лицензии ЕС", en: "EU license number" },
  pdVfLicensePhOther: { ru: "Номер документа (в свободной форме)", en: "Document number (free form)" },
  ...
  dcNotFriends: { ru: "Переписка недоступна: вы больше не в друзьях. Отправьте заявку заново, чтобы продолжить общение.", en: "Chat unavailable: you are no longer friends. Send a new request to continue the conversation." },
  ...
  cookieText: { ru: "Cookie нужны для входа и работы сайта. Аналитика — только с вашего согласия.", en: "Cookies are needed for login and site basics. Analytics only with your consent." },
  cookieAccept: { ru: "Принять", en: "Accept" },
  cookieDecline: { ru: "Только необходимые", en: "Essential only" },
  cookieDeclineShort: { ru: "Только нужные", en: "Essential" },
  cookieMore: { ru: "Политика конфиденциальности", en: "Privacy policy" },
  loading: { ru: "Загрузка…", en: "Loading…" },
  contactFaqTag: { ru: "Частые вопросы", en: "FAQ" },
  contactFaqTitle: { ru: "Вопросы о поддержке", en: "Support questions" },
  contactFaq1Q: { ru: "Как быстро вы отвечаете?", en: "How fast do you respond?" },
  contactFaq1A: { ru: "Обычно мы отвечаем в течение 24 часов в рабочие дни. Срочные вопросы по безопасности аккаунта обрабатываются в приоритетном порядке.", en: "We usually reply within 24 hours on business days. Urgent account security issues are handled with priority." },
  contactFaq2Q: { ru: "Как отменить или вернуть оплату?", en: "How do I cancel or get a refund?" },
  contactFaq2A: { ru: "Напишите нам через форму с темой «Оплата и тарифы», укажите email аккаунта и дату платежа. Условия возврата — в разделе «Оферта».", en: "Contact us via the form with subject 'Payment and plans', include your account email and payment date. Refund terms are in the 'Offer' section." },
  contactFaq3Q: { ru: "Как пожаловаться на специалиста?", en: "How do I report a specialist?" },
  contactFaq3A: { ru: "Выберите тему «Жалоба» в форме обратной связи и опишите ситуацию — мы проверим профиль и, при подтверждении нарушения, примем меры вплоть до блокировки.", en: "Choose 'Complaint' as the subject in the feedback form and describe the situation — we will review the profile and, if confirmed, take action up to suspension." },
  ...
  privFaq1A: { ru: "Только необходимое: имя или псевдоним, email, роль, город, cookie и техданные устройства. Мы не собираем паспортные данные и не храним номера карт.", en: "Only what is necessary: name or pseudonym, email, role, city, cookies and device technical data. We do not collect passport data or store card numbers." },
  privFaq2Q: { ru: "Как удалить мои данные?", en: "How can I delete my data?" },
  privFaq2A: { ru: "Обратитесь в поддержку через страницу «Контакты» с темой «Удаление аккаунта» — мы удалим или обезличим данные в течение 30 дней.", en: "Contact support via the 'Contacts' page with subject 'Account deletion' — we will delete or anonymize your data within 30 days." },
  privFaq3Q: { ru: "Вы продаёте данные третьим лицам?", en: "Do you sell data to third parties?" },
  privFaq3A: { ru: "Нет. Мы передаём данные только платёжным провайдерам, хостинг-сервисам и госорганам по законному требованию — и никогда не продаём их.", en: "No. We only share data with payment providers, hosting services and government authorities upon lawful request — and never sell it." },
  privFaq4Q: { ru: "Как отозвать согласие на cookie?", en: "How do I withdraw cookie consent?" },
  privFaq4A: { ru: "Очистите cookie в настройках браузера или используйте режим приватного просмотра — баннер согласия появится снова при следующем визите.", en: "Clear cookies in your browser settings or use private browsing mode — the consent banner will appear again on your next visit." },
  privFaq5Q: { ru: "Где хранятся данные и насколько это безопасно?", en: "Where is data stored and how secure is it?" },
  privFaq5A: { ru: "Данные передаются по защищённому TLS-каналу и хранятся с контролем доступа и резервным копированием на серверах наших облачных провайдеров.", en: "Data is transmitted over a secure TLS channel and stored with access control and backups on our cloud providers' servers." },
  ...
  promoUntil: { ru: "Акция −30% действует до 1 декабря 2026", en: "−30% promo valid until December 1, 2026" },
  promoBannerTitle: { ru: "Скидка 30% на тарифы специалистов", en: "30% off specialist plans" },
  promoBannerText: { ru: "Оформите подписку со скидкой 30% — акция действует до 1 декабря 2026 года. На доступ работодателя к базе резюме скидка не распространяется.", en: "Get 30% off your subscription — valid until December 1, 2026. The discount does not apply to employer access to the resume database." },
  ...
  liveOnlineClients: { ru: "клиентов на платформе", en: "clients on the platform" },
  liveActiveNow: { ru: "ищут специалистов сейчас", en: "looking for specialists now" },
  planCancelAnytime: { ru: "Без автосписаний · без комиссии со сделок", en: "No auto-renewal · no commission on deals" },
  planRefundLink: { ru: "Условия оплаты и возврата средств", en: "Payment and refund terms" },
  planPopularProof: { ru: "Оптимальное соотношение цены и возможностей", en: "Best balance of price and features" },
  planGuarantee: { ru: "Оплата защищена · чек на почту сразу после оплаты", en: "Secure payment · receipt emailed instantly" },
  calcTitle: { ru: "Калькулятор окупаемости", en: "Payback calculator" },
  calcSubtitle: { ru: "Укажите средний чек заказа и сколько заказов ожидаете в месяц — узнайте, когда подписка окупится.", en: "Enter your average order value and expected orders per month — see when the subscription pays for itself." },
  calcPlan: { ru: "Тариф", en: "Plan" },
  calcAvgCheck: { ru: "Средний чек заказа", en: "Average order value" },
  calcOrdersMonth: { ru: "Заказов в месяц", en: "Orders per month" },
  calcSubCost: { ru: "Стоимость подписки", en: "Subscription cost" },
  perMonthShort: { ru: "мес", en: "mo" },
  calcBreakEven: { ru: "Нужно заказов для окупаемости", en: "Orders needed to break even" },
  calcOrdersUnit: { ru: "шт.", en: "orders" },
  calcMonthlyRevenue: { ru: "Доход в месяц", en: "Monthly revenue" },
  calcNetProfit: { ru: "Чистая прибыль", en: "Net profit" },
  calcDisclaimer: { ru: "Расчёт по введённым вами цифрам. Платформа не гарантирует количество заказов и не является стороной сделки.", en: "Calculated from the figures you entered. The platform does not guarantee any number of orders and is not a party to the deal." },
  calcProfitableNote: { ru: "При таком потоке заказов подписка окупается и приносит прибыль.", en: "At this order flow, the subscription pays for itself and brings profit." },
  calcNeedMoreNote: { ru: "Пока заказов меньше точки окупаемости. Увеличьте число заказов ползунком, чтобы увидеть прибыль.", en: "Currently fewer orders than the break-even point. Increase the orders slider to see profit." },
