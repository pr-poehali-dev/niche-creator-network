...
export const t: Dict = {
  ...
  payNeedLogin: { ru: "Войдите в аккаунт специалиста, чтобы оформить подписку — так оплата точно поступит на ваш профиль.", en: "Sign in to your specialist account to subscribe — this ensures the payment is applied to your profile." },
  ...
  promoBannerText: { ru: "Оформите подписку со скидкой 30% — акция действует до 1 декабря 2026 года.", en: "Get 30% off your subscription — offer valid until December 1, 2026." },
