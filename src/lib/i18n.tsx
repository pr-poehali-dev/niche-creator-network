...
export const t: Dict = {
  ...
  lpStat1: { ru: "специалистов в каталоге", en: "specialists in the catalogue" },
  lpStat2: { ru: "с проверенными документами", en: "with verified documents" },
  lpStat3: { ru: "поддержка и связь", en: "support & messaging" },
  lpStat4: { ru: "городов и стран", en: "cities and countries" },
