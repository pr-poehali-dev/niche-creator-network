...
export const t: Dict = {
  ...
  hiwStep5Text: { ru: "После завершения заказа клиент может оставить отзыв и оценку. Хорошие отзывы поднимают вас выше в поиске и приводят новых клиентов.", en: "After the order is done, the client can leave a review and rating. Good reviews move you higher in search and bring new clients." },
  ...
  pdTabFriends: { ru: "Друзья", en: "Friends" },
  pdMyIdTitle: { ru: "Ваш уникальный ID", en: "Your unique ID" },
  pdMyIdHint: { ru: "Сообщите этот номер другим специалистам, чтобы они могли добавить вас в друзья.", en: "Share this number with other specialists so they can add you as a friend." },
  pdFindFriendTitle: { ru: "Найти специалиста", en: "Find a specialist" },
  pdFindFriendHint: { ru: "Введите уникальный ID специалиста, чтобы отправить заявку в друзья.", en: "Enter a specialist's unique ID to send a friend request." },
  pdFindFriendPh: { ru: "Например: 100042", en: "E.g. 100042" },
  pdFindFriendBtn: { ru: "Найти", en: "Find" },
  pdFriendNotFound: { ru: "Участник с таким ID не найден", en: "No user found with this ID" },
  ...
  pdNoFriends: { ru: "У вас пока нет друзей. Найдите коллег по уникальному ID.", en: "You have no friends yet. Find colleagues by their unique ID." },
  ...
  promoUntil: { ru: "Акция −30% действует до 1 сентября 2026", en: "−30% promo valid until September 1, 2026" },
  promoBannerTitle: { ru: "Скидка 30% на все тарифы", en: "30% off all plans" },
  promoBannerText: { ru: "Оформите подписку со скидкой 30% — акция действует до 1 сентября 2026 года.", en: "Get 30% off your subscription — offer valid until September 1, 2026." },
