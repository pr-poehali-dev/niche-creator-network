...
export const lifeTasks: LifeTask[] = [
  ...
  {
    // Десятая задача: в списке было девять, и на широком экране последняя
    // карточка висела одна в ряду — сетка выглядела оборванной. Эта задача
    // и по существу нужна: проверка человека перед встречей, наймом или
    // сделкой — один из самых частых запросов, а в списке его не было.
    id: "check-person",
    icon: "ScanSearch",
    title: { ru: "Проверить человека", en: "Check a person" },
    hint: { ru: "Перед встречей, наймом или знакомством", en: "Before a meeting, hire or new acquaintance" },
    cat: "cyber",
    services: ["OSINT analyst", "Private investigator"],
    keywords: ["проверить человека", "пробить", "досье", "узнать о человеке", "проверка личности", "osint", "репутация", "кто такой"],
  },
];
