      ...
      {adminTab === "complaints" && (
        <div className="border border-border rounded-sm bg-card overflow-hidden">
          {complaints === null ? (
            ...
            complaints.map((c) => {
              const targetLabel = ({ provider: tr("reportTargetProvider"), client: tr("reportTargetClient"), message: tr("reportTargetMessage") } as Record<string, string>)[c.targetType] || c.targetType;
